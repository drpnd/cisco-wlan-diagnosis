...
def statistics(mac_addr, ts_min, ts_max):
    ...
    db = api.mydb.connect()
    c = db.cursor()
    sql = 'select t0.ts,t0.ms_mac_address,t4.bytes_rx,t4.bytes_tx,t4.pkts_rx,t4.pkts_tx,t4.data_retries,t4.mic_mismatch,t4.mic_missing,t4.most_recent_rssi,t4.most_recent_snr,t4.tx_retries,t4.speed,t4.spatial_stream,t0.vap_ssid,t0.current_channel,t0.ms_bssid,t1.bssid_mac,t2.curr_freq,t2.chan_width,t3.rx_util_percentage,t3.tx_util_percentage,t3.cca_util_percentage,t3.rx_noise_channel_utilization from client_dot11_oper_data t0 inner join client_traffic_stats t4 on t0.ts=t4.ts and t0.ms_mac_address=t4.ms_mac_address inner join ap_radio_oper_data_vap_oper_config t1 on t0.ts=t1.ts and t0.ms_bssid=t1.bssid_mac and t0.ms_ap_slot_id=t1.radio_slot_id inner join ap_radio_oper_data t2 on t1.ts=t2.ts and t1.wtp_mac=t2.wtp_mac and t1.radio_slot_id=t2.radio_slot_id left join rrm_measurement t3 on t2.ts=t3.ts and t2.wtp_mac=t3.wtp_mac and t2.radio_slot_id=t3.radio_slot_id'
